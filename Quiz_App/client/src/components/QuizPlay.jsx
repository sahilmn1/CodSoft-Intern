  ...
  const handleSubmitQuiz = () => {
    ...
    axios
      ...
      .then((response) => {
        ...
        setShowModal(true);
        // Show the modal when the score is available
      })
      .catch((error) => {
        console.error("Error submitting quiz:", error);
      })
      .finally(() => {
        // Reset loading state to false when the submission process is complete
        setIsLoading(false);
      });
  };
      ...
      <div className="card p-4">
        ...
        <div className="d-flex justify-content-between">
          ...
          <button
            ...
            disabled={
              currentQuestion === quiz.questions.length - 1 || isLoading
            }
          >
            Next
          </button>
